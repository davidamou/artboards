...
const FirstPage = () => {
  return (
    <div className="lg:mx-24 m-4 lg:my-10 overflow-hidden">
      <h1 className="md:w-4/6 m-auto text-6xl lg:text-7xl font-bold flex flex-wrap items-center">
        Explore Creative
        <span className="text-lg -space-x-2 overflow-hidden">
      ...
      <div className="mt-20 relative">
        <div className="flex items-center absolute left-0 right-0 -top-12">
        ...
        <div className="flex lg:flex-row flex-col">
          <div className="flex-1 mt-10">
            ...
            {avatars()}
            <div className="mt-4 overflow-hidden rounded-full h-28">
              <Image
          ...
          <div className="h-64 lg:mx-12 mx-0 overflow-hidden lg:w-2/4 w-fit rounded-2xl">
            <Image
              width={25000}
              height={25000}
              className="object-cover w-fit h-fit"
